...
$classes = ($active ?? false)
            ? 'inline-flex items-center p-2 border rounded text-sm font-medium bg-indigo-700 text-indigo-50 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
